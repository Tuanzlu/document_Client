    ...
    <div class="cardList">
      <div class="singleCard" v-for="(item, i) in list" :key="i" style="background-color:#ede4cd;">
        <a-card hoverable class="card" @click="toDoc(item, i)">
          <a-icon type="file-word"  style="color:#98623c; font-size:90px ;margin-left:-20px;margin-top:-20px;padding:10px"/>
          <div>
          <a-dropdown class="set">
            <a class="ant-dropdown-link" @click="(e) => e.preventDefault()">
              <a href="#"><a-icon type="setting" style="color:#d6c6af;font-size:23px"/></a>
            </a>
            <a-menu slot="overlay">
              <a-menu-item>
